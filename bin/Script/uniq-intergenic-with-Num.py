...
df = dff.sort_values(by=['NO. of the present (Non-Genic)'], ascending=False)
df=df.iloc[:60]
...
bars = ax.bar(
    ...
    height=df["NO. of the present (Non-Genic)"],
...
ax.set_title('Unique repeats of the non-genic region',fontsize=20, pad=15, color='#333333',weight='bold')
